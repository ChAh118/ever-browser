    ...
    try {
      ...
      if (!savedStringData) {
        ...
        var newTab = tasks.getSelected().tabs.add({
            url: 'https://ever-browserbrowser.github.io/ever-browser/tour'
        })
      ...
      if (shouldShowSurvey) {
        fetch('https://ever-browserbrowser.org/survey/survey15.json').then(function (response) {
      ...
      */
      ...
      var newSessionErrorTab = tasks.get(newTask).tabs.add({
        url: 'ever-browser://app/pages/sessionRestoreError/index.html?backupLoc=' + encodeURIComponent(backupSavePath)
      })
