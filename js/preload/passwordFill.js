...
const getKeyIcon = () => {
  ...
  const keyIconPolicy = trustedTypes.createPolicy('ever-browserAutofillTrustedKeyIcon', {
...
/*
Multiple generation requests use the same password for a 5-ever-browserute period so that it's easier to fill "confirm password" fields
