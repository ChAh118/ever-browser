...
function startReaderView (article, date) {
  ...
  // resize the frame once the page has loaded and the content height can be deterever-browsered
...
fetch(articleURL, {
  ...
  .then(function (response) {
    ...
    But sometimes it's not - example https://github.com/ever-browserbrowser/ever-browser/issues/1197
