...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    if (details.resourceType === 'mainFrame' && details.responseHeaders) {
      ...
      // Needed to save files correctly: https://github.com/ever-browserbrowser/ever-browser/issues/1717
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('ever-browser://app/pages/pdfViewer') || details.webContents.getURL().startsWith('ever-browser://app/reader/') || details.webContents.getURL() === 'ever-browser://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'ever-browser://app',
