function buildAppMenu (options = {}) {
  ...
  var quitAction = {
    ...
    accelerator: getFormattedKeyMapEntry('quitEver Browser'),
    click: function (item, window, event) {
      if (!event.triggeredByAccelerator) {
        app.quit()
      }
  ...
  var preferencesAction = {
    ...
    click: function (item, window) {
      sendIPCToWindow(window, 'addTab', {
        url: 'ever-browser://app/pages/settings/index.html'
      })
    }
  }
    ...
    ...(process.platform === 'darwin' ? [
      {
        ...
        submenu: [
          {
            label: l('appMenuEver Browserimize'),
            accelerator: 'CmdOrCtrl+M',
            role: 'ever-browserimize'
          },
          {
      ...
      submenu: [
        {
          ...
          click: function () {
            openTabInWindow('https://github.com/ever-browserbrowser/ever-browser/wiki#keyboard-shortcuts')
          }
        },
        {
          label: l('appMenuReportBug'),
          click: function () {
            openTabInWindow('https://github.com/ever-browserbrowser/ever-browser/issues/new')
          }
        },
        {
          label: l('appMenuTakeTour'),
          click: function () {
            openTabInWindow('https://ever-browserbrowser.github.io/ever-browser/tour/')
          }
        },
        {
          label: l('appMenuViewGithub'),
          click: function () {
            openTabInWindow('https://github.com/ever-browserbrowser/ever-browser')
          }
        },
