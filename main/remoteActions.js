...
ipc.handle('ever-browserimize', function (e) {
  windows.windowFromContents(e.sender).win.ever-browserimize()
  // workaround for https://github.com/ever-browserbrowser/ever-browser/issues/1662
  e.sender.send('ever-browserimize')
})
