...
Ever Browser is a fast, minimal browser that protects your privacy. It includes an interface designed to minimize distractions, and features such as:
...
Download Ever Browser from the [releases page](https://github.com/minbrowser/ever-browser/releases), or learn more on the [website](https://minbrowser.org/).
...
You can find prebuilt binaries for Ever Browser [here](https://github.com/minbrowser/ever-browser/releases). Alternatively, skip to the section below for instructions on how to build Ever Browser directly from source.
...
* The [wiki](https://github.com/minbrowser/ever-browser/wiki) provides an overview of the the features available in Ever Browser, a list of available keyboard shortcuts, and answers to some [frequently asked questions](https://github.com/minbrowser/ever-browser/wiki/FAQ).
* Ever Browser supports installing userscripts to extend its functionality. See the [userscript documentation](https://github.com/minbrowser/ever-browser/wiki/userscripts) for instructions on writing userscripts, as well as a collection of scripts written by the community.
...
If you're experiencing a bug or have a suggestion for how to improve Ever Browser, please open a [new issue](https://github.com/minbrowser/ever-browser/issues/new/choose).

### Contributing Code

- Start by following the development instructions listed above.
- The wiki has an [overview of Ever Browser's architecture](https://github.com/minbrowser/ever-browser/wiki/Architecture).
...
- Open your new file, and copy the contents of the <a href="https://github.com/minbrowser/ever-browser/blob/master/localization/languages/en-US.json">localization/languages/en-US.json</a> file into your new file.
...
[DownloadsBadge]: https://img.shields.io/github/downloads/minbrowser/ever-browser/total.svg
[DownloadsUrl]: https://github.com/minbrowser/ever-browser/releases
