...
async function afterPackageBuilt (path, arch) {
  var installerOptions = {
    artifactName: 'ever-browser-${version}-${arch}.deb',
    packageName: 'ever-browser',
    icon: 'icons/icon256.png',
    category: 'Network;WebBrowser',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'Ever Browser Developers <280953907a@zoho.com>',
    description: 'Ever Browser is a fast, ever-browserimal browser that protects your privacy.',
